        ...
        <div class="row">
          <div class="col">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-9">
                <input class="form-control" type="text" placeholder="Nhập tên Danh Mục" value="{{ $cate->cate_name }}" name="name" id="name" required>
              </div>
            </div>
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-9">
                ...
                <img id="event__img-0" src="{{URL::to('/')}}/image/category/{{$cate->cate_img}}" alt="slider" width="50%" height="250px">
              </div>
            </div>
          </div>
        </div>
