...
<tr>
    ...
    <td class="flex-column align-items-center justify-content-around">
        <a href="{{route('LoaiSanPham.show',$item->cate_id)}}" method="get" title="Xem chi tiết">
            <i class="icofont icofont-paper" style="font-size:20px;color:green"></i>
        </a>
        <a href="{{route('LoaiSanPham.edit',$item->cate_id)}}" title="Chỉnh sửa">
            <i class="icofont icofont-pencil-alt-5" style="font-size:20px;color:blue"></i>
        </a>
        <a data-url="{{URL::to('/XoaLoaiSanPham',$item->cate_id)}}" class="delete-item" title="Xóa">
