...
<tr>
    ...
    <td class="flex-column align-items-center justify-content-around">
        <a href="{{route('NhaCungCap.show',$item->port_id)}}" method="get" title="Xem chi tiết">
            <i class="icofont icofont-paper" style="font-size:20px;color:green"></i>
        </a>
        <a href="{{route('NhaCungCap.edit',$item->port_id)}}" title="Chỉnh sửa">
            <i class="icofont icofont-pencil-alt-5" style="font-size:20px;color:blue"></i>
        </a>
        <a data-url="{{URL::to('/XoaNhaCungCap',$item->port_id)}}" class="delete-item" title="Xóa">
