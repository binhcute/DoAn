...
@if($trash != null)
<div class="page-title-section section" data-bg-image="{{URL::to('/')}}/image/example/background-null.jpg">
    @else
            ...
            <div class="row">
                <div class="col">
                    <div class="page-title">
                        @if($trash != null)
                        <h1 class="title">{{$trash->port_name}}</h1>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('index')}}">Trang Chủ</a></li>
                            <li class="breadcrumb-item active">Nhà Cung Cấp</li>
                        </ul>
                        <h3>Nhà cung cấp này đã bị xóa quý khách vẫn có thể tiếp tục mua các sản phẩm này</h3>
                        @else
                ...
                <div class="row learts-mb-n20">
                    ...
                    <div class="col-md col-12 align-self-center learts-mb-20">
                        <div class="isotope-filter shop-product-filter" data-target="#shop-products">
                            @if($trash != null)
                            <button class="active" data-filter="#">{{$trash->port_name}} (Nhà cung cấp này đã bị xóa)</button>
                            @else
