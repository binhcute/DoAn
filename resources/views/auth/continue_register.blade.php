...
<head>
    ...
    <link rel="stylesheet" href="{{asset('server/assets/css/style.css')}}">
        ...
        <div class="row">
          <div class="col">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-9">
                <input class="form-control" disabled="disabled" type="text" placeholder="Nhập tên tài khoản" name="username" value="{{Auth::user()->username}}">
              </div>
            </div>
            <div class="mb-3 row">
